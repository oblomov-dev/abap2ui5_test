CLASS zcl_2ui5_hlp_tree_xml DEFINITION
  PUBLIC.

  PUBLIC SECTION.

    TYPES ty_o_me TYPE REF TO zcl_2ui5_hlp_tree_xml.
    ...
    TYPES ty_t_nodes TYPE STANDARD TABLE OF REF TO zcl_2ui5_hlp_tree_xml WITH EMPTY KEY.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result) TYPE REF TO zcl_2ui5_hlp_tree_xml.
...
CLASS ZCL_2UI5_HLP_TREE_XML IMPLEMENTATION.
  ...
  METHOD factory.
    ...
    DATA(lo_root) = NEW zcl_2ui5_hlp_tree_xml(  ).
...
*      data(lv_val) = lo_node3->get_value(  ).
  ...
  METHOD _read_childs.
    ...
    DO.
      ...
      DATA(lo_node) = NEW zcl_2ui5_hlp_tree_xml(  ).
